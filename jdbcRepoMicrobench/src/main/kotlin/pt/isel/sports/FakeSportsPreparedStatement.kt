...
class FakeSportsPreparedStatement : PreparedStatement {
    override fun executeQuery(): ResultSet = FakeSportsResultSet()
    ...
    override fun getGeneratedKeys(): ResultSet = FakeSportsResultSet()
